...
<div id="wp2023-tabletop-frame-editor">
    ...
    <img id="wp2023-image-preview" style="max-width: 100%; height: auto; display: none;">
...
<!-- Include your JavaScript here or enqueue it separately -->
<script>
// Your JavaScript code for handling image upload and Cropper.js initialization
</script>
<?php
    return ob_get_clean();
}
