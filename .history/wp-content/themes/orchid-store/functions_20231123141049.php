...
// function wp2023_remove_add_to_cart_button() {
//     global $product;
//     $specific_id = 123; // Replace with your specific product ID

//     if ($product->get_id() == $specific_id) {
//         remove_action('woocommerce_after_shop_loop_item', 'woocommerce_template_loop_add_to_cart', 10);
//         remove_action('woocommerce_single_product_summary', 'woocommerce_template_single_add_to_cart', 30);
//     }
// }
// add_action('wp', 'wp2023_remove_add_to_cart_button');