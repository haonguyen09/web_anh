...
jQuery(document).ready(function($) {
    ...
    function readAndPreviewImage(file, index) {
        ...
        reader.onload = function(e) {
            ...
            let thumbnailContainer = $('<img class="thumbnail">');
            thumbnailContainer.css({
                'max-width': '100px',
                'max-height': '100px', // Add max-height for better control
                'margin-right': '5px',
                'cursor': 'pointer',
    ...
    var maxUploads = wp2023_settings && !isNaN(wp2023_settings.maxUploads) ? parseInt(wp2023_settings
        .maxUploads, 10) : 10;
