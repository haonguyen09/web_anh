...
jQuery(document).ready(function($) {
    // Add an input field above the "Add to Cart" button
    var inputField = '<input type="text" id="userFullName" placeholder="Enter your full name" />';
    $('.single-product-page .cart').before(inputField);
