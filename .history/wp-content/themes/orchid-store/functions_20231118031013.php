...
jQuery(document).ready(function($) {
    ...
    $('#wp2023-custom-image').on('change', function(event) {
        ...
        Array.from(files).forEach((file, index) => { // Make sure to pass the index here
            ...
            reader.onload = function(e) {
                ...
                thumbnail.attr('data-index',
                    index); // Set an index attribute for identification
                $('#wp2023-image-thumbnails-container').append(
                    thumbnail); // Append the thumbnail
                thumbnail.show(); // Make sure to show the thumbnail
            };
    ...
    $('#wp2023-image-thumbnails-container').on('click', '.thumbnail', function() {
        ...
        reader.onload = function(e) {
            ...
            // Open the modal
            $('#imageModal').modal('show'); // This depends on your modal implementation
            ...
            // Initialize Cropper.js on the modal image
            currentCropper = new Cropper($('#image-to-edit')[0], {
                aspectRatio: 1, // other options as needed
            });
            // croppers[index] = {
            //     image: $('#modal-image-preview')[0],
            //     cropper: cropper
            // };
        };
        reader.readAsDataURL(file);
