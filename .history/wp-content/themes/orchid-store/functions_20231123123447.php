...
function wp2023_redirect_to_shopee($cart_item_key, $product_id, $quantity, $variation_id, $variation, $cart_item_data) {
...
add_action('woocommerce_add_to_cart', 'wp2023_redirect_to_shopee', 10, 6);