...
add_action( 'woocommerce_template_single_add_to_cart', 'remove_my_action', 10 );
function remove_my_action() {
	remove_action( 'woocommerce_template_single_add_to_cart', 'remove_my_action', 0 );
}
?>
...
// }
// }
// add_action('woocommerce_template_single_add_to_cart', 'test', 0);
