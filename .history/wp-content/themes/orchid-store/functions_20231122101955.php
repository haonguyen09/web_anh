...
function wp2023_redirect_add_to_cart() {
    ...
    if (!empty($shopee_link)) {
        ...
        echo '<input type="text" id="userFullName" placeholder="Enter your full name" style="margin-bottom: 20px;">';

        // Add inline JavaScript for handling the redirection
        ?>
<script type="text/javascript">
jQuery(document).ready(function($) {
    // Intercept the Add to Cart form submit event
    $('form.cart').on('submit', function(e) {
        ...
        if (userFullName) {
            $.ajax({
                ...
                error: function() {
                    console.log('Could not save name. Please try again.');
                }
            });
        } else {
...
//             // Assuming you want the ID of the first category
...
//     error_log('No valid product category found.');
//     return 0; // or return a default category ID if appropriate
// }
