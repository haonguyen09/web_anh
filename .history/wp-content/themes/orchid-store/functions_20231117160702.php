...
add_action('wp_ajax_nopriv_save_full_name', 'wp2023_save_full_name'); // For logged out users
...
function wp2023_save_full_name() {
    ...
    // Assuming you have extended the wp_wc_customer_lookup table to include a full_name column
    global $wpdb;
    $wpdb->update(
        "{$wpdb->prefix}wc_customer_lookup",
        array('full_name' => $full_name),
        array('user_id' => get_current_user_id()) // This needs to match an existing user ID in the table
    );
