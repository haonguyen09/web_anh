...
<div id="wp2023-tabletop-frame-editor">
    ...
    <div id="imageModal" class="modal">
        <div class="modal-content">
            <img id="modal-image-preview" style="max-width: 100%; height: auto;">
        </div>
    ...
    <div id="image-edit-modal" class="modal" style="display: none;">
        ...
        <div class="modal-content">
            ...
            <!-- Your Cropper.js container, where the image will be displayed and edited -->
            <!-- Add your controls for zoom, rotate, etc. -->
        </div>
    </div>
...
jQuery(document).ready(function($) {
    ...
    $('#wp2023-image-thumbnails-container').on('click', '.thumbnail', function() {
        ...
        reader.onload = function(e) {
            ...
            let cropper = new Cropper($('#modal-image-preview')[0], {
                aspectRatio: 1,
