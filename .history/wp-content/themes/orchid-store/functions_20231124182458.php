...
function wp2023_enqueue_scripts() {
    if (is_page('khung_de_ban') || is_singular('product')) {
        ...
        // wp_enqueue_script('wp2023-custom-script', get_template_directory_uri() . '/js/custom-script.js', array('jquery'), '1.0.0', true);
    
        // $max_images = get_option('wp2023_max_images', 10); // Fetch this from your WordPress settings or options.
    
        // wp_localize_script('wp2023-custom-script', 'wp2023_settings', array(
        //     'maxUploads' => $max_images,
        // ));
    }
}
...
jQuery(document).ready(function($) {
    ...
    $('#image-upload-form').on('submit', function(e) {
        ...
        // var files = $('#wp2023-custom-image')[0].files; // Ensure this ID is correct
