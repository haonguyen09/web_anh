...
<div id="wp2023-tabletop-frame-editor">
    ...
    <div id="wp2023-tabletop-frame-editor">
        ...
        <!-- Existing buttons for zoom, rotate, and crop -->
    ...
    <div id="imageModal" class="modal">
        ...
        <div class="modal-footer">
            ...
            <button id="modal-apply-crop">Apply Crop</button>
        </div>
    </div>
...
jQuery(document).ready(function($) {
    ...
    $('#wp2023-image-thumbnails-container').on('click', '.thumbnail', function() {
        ...
        let file = $('#wp2023-custom-image').prop('files')[index];

        let reader = new FileReader();
        reader.onload = function(e) {
            let img = $('<img id="wp2023-image-preview" style="max-width: 100%; height: auto;">');
            img.attr('src', e.target.result);
            $('#wp2023-image-preview-container').html(img);
