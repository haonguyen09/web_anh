    ...
    // if (class_exists('WP2023_DB')) {
        ...
        'wp2023_images' => "
            CREATE TABLE {$wpdb->prefix}wp2023_images (
                ...
                CustomerId INT NOT NULL, // Link to WooCommerce Customer ID
                WooCommerceProductId INT NOT NULL, // Link to WooCommerce Product ID
                TemplateId INT NOT NULL, // Link to your custom template ID
                PRIMARY KEY (ImageId)
            ) $charset_collate;"
        ];
